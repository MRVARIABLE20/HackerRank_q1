...
ROLE_CLEARANCE: dict[str, Classification] = {
    "intern": Classification.PUBLIC,
    "analyst": Classification.INTERNAL,
    "manager": Classification.CONFIDENTIAL,
    "cfo": Classification.RESTRICTED,
    "ceo": Classification.RESTRICTED,
    "admin": Classification.RESTRICTED,
    "auditor": Classification.RESTRICTED,
}
